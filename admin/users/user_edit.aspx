<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="HT.Web.admin.users.user_edit" ValidateRequest="false" %>
    ...
    $(function () {
        $("#linkImgUrl").click(function () {
            layer.open({
                ...
                shade: 0.8,
                area: ['800px', '90%'],
                content: '<img src=' + $("#txtAvatar").val() + ' width="100%"  />'
            });
        })
        //初始化表单验证
        $("#form1").initValidform();
...
<div class="tab-content">
  ...
  <dl>
    <dt>手机号码</dt>
    <dd><asp:TextBox ID="txtMobile" runat="server" CssClass="input normal" datatype="m" sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=userphone_validate"></asp:TextBox></dd>
  </dl>
  <dl>
    <dt>邮箱账号</dt>
    <dd><asp:TextBox ID="txtEmail" runat="server" CssClass="input normal" datatype="e" sucmsg=" " ignore="ignore"></asp:TextBox> <span class="Validform_checktip">*取回密码时用到</span></dd>
  </dl>
  <dl>
    <dt>用户昵称</dt>
