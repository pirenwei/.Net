<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_edit.aspx.cs" Inherits="HT.Web.admin.users.message_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <div id="div_add" runat="server">
      <dl>
        <dt>收件人</dt>
        <dd>
          <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="*1-5000" sucmsg=" " TextMode="MultiLine"></asp:TextBox>
