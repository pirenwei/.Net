<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goods_reserve_list.aspx.cs" Inherits="HT.Web.admin.goods.goods_reserve_list" %>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      <th width="6%">选择</th>
      <th align="left">商品标题</th>
      <th width="10%">数量</th>
      <th width="10%">用户名</th>
      <th width="10%">姓名</th>
      <th width="10%">手机号</th>
      <th width="10%">QQ号</th>
      <th align="left" width="16%">预订时间</th>
    </tr>
  </HeaderTemplate>
  <ItemTemplate>
    <tr>
