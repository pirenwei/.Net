<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goods_category_edit.aspx.cs" Inherits="HT.Web.admin.goods.goods_category_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="goods_category_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="goods_category_list.aspx"><span>内容类别</span></a>
  <i class="arrow"></i>
  <span>编辑分类</span>
</div>
