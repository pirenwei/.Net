<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goods_edit.aspx.cs" Inherits="HT.Web.admin.goods.goods_edit" ValidateRequest="false"%>
  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <li><a href="javascript:;">活动属性</a></li>
...
<div class="tab-content">
  ...
  <dl>
    <dt>购买链接</dt>
    <dd>
      <asp:TextBox ID="txtLinkUrl" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" " />
  ...
  <dl>
    <dt>取货地址</dt>
    <dd>
      <asp:TextBox ID="txtPlace" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" "/>
      <span class="Validform_checktip">*</span>
    </dd>
  </dl>
  <dl>
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        <asp:RadioButtonList ID="rblIsNew" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
            <asp:ListItem Value="0" Selected="True">否</asp:ListItem>
            <asp:ListItem Value="1">是</asp:ListItem>
        </asp:RadioButtonList>
      </div>
