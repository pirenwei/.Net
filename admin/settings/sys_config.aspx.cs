...
namespace HT.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("sys_config", HTEnums.ActionEnum.View.ToString()); //检查权限
                ShowInfo();
            }
        }
        ...
        private void ShowInfo()
        {
            ...
            //}
            smspassword.Text = model.smspassword;
        ...
        {
            ChkAdminLevel("sys_config", HTEnums.ActionEnum.Edit.ToString()); //检查权限
            BLL.siteconfig bll = new BLL.siteconfig();
            Model.siteconfig model = bll.loadConfig();
            try
            {
                ...
                model.smspassword = smspassword.Text;
                ////判断密码是否更改
                ...
                AddAdminLog(HTEnums.ActionEnum.Edit.ToString(), "修改系统配置信息"); //记录日志
