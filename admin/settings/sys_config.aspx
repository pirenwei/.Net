<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="HT.Web.admin.settings.sys_config" ValidateRequest="false" %>
  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <%--<li><a href="javascript:;" style="display:none">文件上传设置</a></li>--%>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  ...
  <dl>
    <dt>首页标题(SEO)</dt>
    <dd>
      <asp:TextBox ID="webtitle" runat="server" CssClass="input" TextMode="MultiLine"/>
  ...
  <dl>
    <dt>页面关健词(SEO)</dt>
    <dd>
      <asp:TextBox ID="webkeyword" runat="server" CssClass="input" TextMode="MultiLine"/>
  ...
  <dl>
    <dt>页面描述(SEO)</dt>
    <dd>
      <asp:TextBox ID="webdescription" runat="server" CssClass="input" TextMode="MultiLine"/>
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    <dt>用户编号</dt>
    <dd>
      <asp:TextBox ID="smsusername" runat="server" CssClass="input normal" />
      <span class="Validform_checktip">*短信平台注册的用户编号</span>
    </dd>
  </dl>
  <dl>
    <dt>签权验证</dt>
    <dd>
      <asp:TextBox ID="smspassword" runat="server" CssClass="input normal"/>
      <span class="Validform_checktip">*MD5(企业代码+用户密码),32位加密小写</span>
    </dd>
  </dl>
</div>
<!--/手机短信设置-->
