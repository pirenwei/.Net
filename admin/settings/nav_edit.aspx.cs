    ...
    public partial class nav_edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                TreeBind(HTEnums.NavigationEnum.System.ToString()); //绑定导航菜单
        ...
        private bool DoAdd()
        {
            try
            {
                ...
                model.nav_type = HTEnums.NavigationEnum.System.ToString();
                ...
                if (bll.Add(model) > 0)
                {
                    AddAdminLog(HTEnums.ActionEnum.Add.ToString(), "添加导航菜单:" + model.title); //记录日志
                    return true;
                }
            }
            catch
        ...
        private bool DoEdit(int _id)
        {
            try
            {
                ...
                if (bll.Update(model))
                {
                    AddAdminLog(HTEnums.ActionEnum.Add.ToString(), "修改导航菜单:" + model.title); //记录日志
                    return true;
                }
            }
            catch
