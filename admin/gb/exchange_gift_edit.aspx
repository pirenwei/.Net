<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="exchange_gift_edit.aspx.cs" Inherits="HT.Web.admin.gb.exchange_gift_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="exchange_gift_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="exchange_gift_list.aspx"><span>G币兑换</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
...
<div class="tab-content">
  ...
  <dl>
    <dt>编号</dt>
    <dd>
      <asp:TextBox ID="txtExchangeNo" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " />
