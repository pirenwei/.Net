...
{
    public partial class article_notice_category_edit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == HTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改类别成功！", "article_notice_category_list.aspx");
            }
            else //添加
            {
                ChkAdminLevel("article_notice", HTEnums.ActionEnum.Add.ToString()); //检查权限
                if (!DoAdd())
                {
                    JscriptMsg("保存过程中发生错误！", "");
                    return;
                }
                JscriptMsg("添加类别成功！", "article_notice_category_list.aspx");
            }
        }
