...
{
    public partial class article_video_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}&page={3}",
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            this.RptBind("id>0 AND channel_id= " + channel_id + CombSqlTxt(this.category_id, this.keywords, this.property), "sort_id asc,add_time desc,id desc");
        }

        //关健字查询
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}", this.category_id.ToString(), this.keywords, ddlProperty.SelectedValue));
        }
        ...
        protected void lbtnViewTxt_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}&page={3}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}",
               this.category_id.ToString(), this.keywords, this.property));
        }
        ...
        {
            ChkAdminLevel("article_video", HTEnums.ActionEnum.Audit.ToString()); //检查权限
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    {
                        new BLL.user_point_log().Add(model.user_id, model.user_name, userConfig.pointgb4, "发布摄影图片获得" + userConfig.pointgb4 + "个G币", false);
            ...
            JscriptMsg("批量审核成功！", Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}",
                this.category_id.ToString(), this.keywords, this.property));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("article_video_list.aspx", "category_id={0}&keywords={1}&property={2}", this.category_id.ToString(), this.keywords, this.property));
        }
