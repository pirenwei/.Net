<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_message_edit.aspx.cs" Inherits="HT.Web.admin.article.article_message_edit" %>
...
<head>
    ...
    <script type="text/javascript">
        function fn_activityshow() {
            if ($("#ddlCategoryId").val() == "12") {
                $(".activity").show();
            } else {
                $(".activity").hide();
            }
...
<!--导航栏-->
<div class="location">
  <a href="article_message_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="article_message_list.aspx"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑内容</span>
</div>
...
<div class="tab-content">
  ...
  <dl class="activity">
    <dt>活动地址</dt>
    <dd>
      <asp:TextBox ID="txtAddress" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
      <span class="Validform_checktip"></span>
    </dd>
  </dl>
  <dl class="activity">
