<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_notice_edit.aspx.cs" Inherits="HT.Web.admin.article.article_notice_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="article_notice_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="article_notice_list.aspx"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑内容</span>
</div>
