...
{
    public partial class article_notice_list : Web.UI.ManagePage
    {
        protected int totalCount;
        protected int page;
        protected int pageSize;

        protected int channel_id = 1;//notice
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("article_notice", HTEnums.ActionEnum.View.ToString()); //检查权限
                TreeBind(); //绑定类别
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}&page={3}",
        ...
        {
            ChkAdminLevel("article_notice", HTEnums.ActionEnum.Edit.ToString()); //检查权限
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}", this.category_id.ToString(), this.keywords, ddlProperty.SelectedValue));
        }
        ...
        protected void lbtnViewTxt_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}&page={3}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}",
               this.category_id.ToString(), this.keywords, this.property));
        }
        ...
        {
            ChkAdminLevel("article_notice", HTEnums.ActionEnum.Audit.ToString()); //检查权限
            BLL.ht_article bll = new BLL.ht_article();
            Repeater rptList = new Repeater();
            switch (this.prolistview)
            {
            ...
            JscriptMsg("批量审核成功！", Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}",
                this.category_id.ToString(), this.keywords, this.property));
        }
        ...
        {
            ChkAdminLevel("article_notice", HTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("article_notice_list.aspx", "category_id={0}&keywords={1}&property={2}", this.category_id.ToString(), this.keywords, this.property));
        }
