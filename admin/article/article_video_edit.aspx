<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_video_edit.aspx.cs" Inherits="HT.Web.admin.article.article_video_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="article_video_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="article_video_list.aspx"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑内容</span>
</div>
...
<div class="tab-content">
  ...
  <dl>
    <dt>视频路径</dt>
    <dd>
      <asp:TextBox ID="txtVideoSrc" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" " />
      <span class="Validform_checktip"></span>
    </dd>
  </dl>
  <dl>
