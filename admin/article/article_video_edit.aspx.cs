...
{
    public partial class article_video_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            ddlArea.SelectedValue = model.area;
            txtVideoSrc.Text = model.video_src;
        ...
        private bool DoAdd()
        {
            ...
            model.video_src = txtVideoSrc.Text.Trim();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == HTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改成功！", "article_video_list.aspx");
            }
            else //添加
            {
                ChkAdminLevel("article_video", HTEnums.ActionEnum.Add.ToString()); //检查权限
