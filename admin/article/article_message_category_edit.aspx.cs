...
{
    public partial class article_message_category_edit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == HTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改类别成功！", "article_message_category_list.aspx");
            }
            else //添加
            {
                ...
                JscriptMsg("添加类别成功！", "article_message_category_list.aspx");
            }
        }
