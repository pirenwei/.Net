...
{
    public partial class article_ztly_edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("article_ztly", HTEnums.ActionEnum.Add.ToString()); //检查权限
                //TreeBind();
                TreeBindArea();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == HTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改成功！", "article_ztly_list.aspx");
            }
            else //添加
            {
                ChkAdminLevel("article_ztly", HTEnums.ActionEnum.Add.ToString()); //检查权限
