<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_server_edit.aspx.cs" Inherits="HT.Web.admin.car.car_server_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="car_server_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="car_server_list.aspx"><span>包车服务</span></a>
  <i class="arrow"></i>
  <span>编辑包车服务</span>
</div>
...
<div class="tab-content">
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlType" runat="server" datatype="*" sucmsg=" ">
            <asp:ListItem Value="">请选择服务</asp:ListItem>
            <asp:ListItem Value="1">包车服务</asp:ListItem>
            <asp:ListItem Value="2">接送服务</asp:ListItem>
        </asp:DropDownList>
      </div>
    </dd>
  </dl>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        <asp:RadioButtonList ID="rblIsRecommend" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlArea" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlArea_Changed" ></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlAreaLine" runat="server"></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    <dt>市场价格</dt>
    <dd>
      <asp:TextBox ID="txtMarketPrice" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox> 元
  ...
  <dl>
    <dt>销售价格</dt>
    <dd>
      <asp:TextBox ID="txtSellPrice" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox> 元
      <span class="Validform_checktip">*</span>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*关联景区，可多个，以英文逗号分隔</span>
    </dd>
  </dl>
  <dl>
    <dt>发布时间</dt>
