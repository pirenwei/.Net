<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_apply_list2.aspx.cs" Inherits="HT.Web.admin.car.car_apply_list2" %>
...
<div class="table-container">
  ...
  <table style="overflow:auto; width:180%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
        <th width="6%"><nobr>选择</nobr></th>
        <th align="left"><nobr>标题</nobr></th>
        <th><nobr>机场</nobr></th>
        <th><nobr>接机日期</nobr></th>
        <th><nobr>下车地点</nobr></th>
        <th><nobr>送机日期</nobr></th>
        <th><nobr>上车地点</nobr></th>
        <th><nobr>乘车人数</nobr></th>
        <th><nobr>行李件数</nobr></th>
        <th><nobr>姓名</nobr></th>
        <th><nobr>联系电话</nobr></th>
        <th><nobr>QQ</nobr></th>
        <th><nobr>邮箱</nobr></nobr></th>
  ...
  <ItemTemplate>
    <tr>
        ...
        <td align="center"><nobr><%#Eval("airport")%></nobr></td>
        <td align="center"><nobr><%#Eval("begin_date")%></nobr></td>
        <td align="center"><nobr><%#Eval("begin_place")%></nobr></td>
        <td align="center"><nobr><%#Eval("end_date")%></nobr></td>
