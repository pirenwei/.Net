<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bbs_topic_list.aspx.cs" Inherits="HT.Web.admin.bbs.bbs_topic_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="bbs_topic_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
        ...
        <div class="menu-list">
          ...
          <div class="rule-single-select">
            <asp:DropDownList ID="ddlProperty" runat="server" AutoPostBack="True" onselectedindexchanged="ddlProperty_SelectedIndexChanged">
                ...
                <asp:ListItem Value="isElite">精华</asp:ListItem>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><a href="bbs_topic_edit.aspx?action=<%#HTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
      <td align="center"><%#new HT.BLL.ht_bbs_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
      <td align="center"><%#Eval("user_name")%></td>
      <td align="center"><%#Eval("click")%>/<%#new HT.BLL.ht_bbs_topic().GetCountReply(Utils.ObjToInt(Eval("id"))) %></td>
      <td>
        <div class="btn-tools">
          ...
          <asp:LinkButton ID="lbtnIsElite" CommandName="lbtnIsElite" runat="server" CssClass='<%# Convert.ToInt32(Eval("is_elite")) == 1 ? "red selected" : "red"%>' ToolTip='<%# Convert.ToInt32(Eval("is_elite")) == 1 ? "取消精华" : "设置精华"%>' />
        </div>
      </td>
      <td><%#string.Format("{0:g}",Eval("add_time"))%></td>      
      <td align="center"><%#Eval("status").ToString()=="0"?"正常":"无效"%></td>
      <td align="center">
        <a href="bbs_topic_edit.aspx?action=<%#HTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
