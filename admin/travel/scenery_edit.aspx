<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scenery_edit.aspx.cs" Inherits="HT.Web.admin.travel.scenery_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="scenery_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="scenery_list.aspx"><span>景区管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
