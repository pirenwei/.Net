<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hotel_edit.aspx.cs" Inherits="HT.Web.admin.travel.hotel_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="hotel_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="hotel_list.aspx"><span>酒店管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <li><a href="javascript:;">房型管理</a></li>
        <li><a href="DNhotel_list.aspx">东南旅行社</a></li>
        <li><a href="LRhotel_list.aspx">LateRooms</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  <dl>
    <dt>东南旅行社酒店编号</dt>
    <dd>
      <asp:TextBox ID="txtDNProdNo" runat="server" CssClass="input normal"/>
  ...
  <dl>
    <dt>LateRooms酒店编号</dt>
    <dd>
      <asp:TextBox ID="txtLRProdNo" runat="server" CssClass="input normal"/>
      <span class="Validform_checktip"></span>
    </dd>
  </dl>
  <dl>
  ...
  <dl>
    ...
    <dt>电话</dt>
    <dd>
        <asp:TextBox ID="TextTelphone" runat="server" CssClass="input" datatype="n" sucmsg=" "></asp:TextBox>
    </dd>
  </dl>
  <dl>
    <dt>排序数字</dt>
...
<div class="tab-content" style="display:none; padding:1px 10px">
    <iframe src="hotel_rmtp_list.aspx?hotel_id=<%=this.id %>" id="iframepage" name="iframepage" frameBorder="0" scrolling="no" width="100%" height="530"></iframe>
</div>
