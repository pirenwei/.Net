<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travel_edit.aspx.cs" Inherits="HT.Web.admin.travel.travel_edit" %>
...
<!--导航栏-->
<div class="location">
  <a href="travel_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="travel_list.aspx"><span>行程管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;">行程主题</a></li>
        <li><a href="travel_day_list.aspx?travel_id=<%=this.id %>">每日行程</a></li>
      </ul>
    </div>
  </div>
</div>
