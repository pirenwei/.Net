<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop_coupon_edit.aspx.cs" Inherits="HT.Web.admin.travel.shop_coupon_edit" %>
...
<div class="tab-content" style="border:none; padding:0">
  ...
  <dl>
    <dt>使用说明</dt>
    <dd>
      <asp:TextBox ID="txtRemark" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " />
